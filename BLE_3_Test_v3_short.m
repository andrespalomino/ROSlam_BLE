...
robots(2).position = [-1.5;     % x
                      0;     % y
                      0];    % z
                  
robots(3).position = [1.5;    % x
                      0;     % y
                      0];    % z     
...
robots(1).pos_flip = [0 0 0 0;-1.5 0 -1.5 0;1.5 0 1.5 0];
robots(2).pos_flip = [0 0 0 0;-1.5 0 -1.5 0;1.5 0 1.5 0];
robots(3).pos_flip = [0 0 0 0;-1.5 0 -1.5 0;1.5 0 1.5 0];

pos_inicial = [0 0 0 0;-2 0 -2 0;2 0 2 0];
% REAL DATA Distancias Mts 
data_real = [1.5,1.5;
             sqrt(1.5^2+1.2^2),sqrt(1.5^2+1.2^2);
             sqrt((1.5+0.9)^2+1.2^2), sqrt((1.5-0.9)^2+1.2^2);
             1.5+0.9, 0.6;
             sqrt((1.5+0.9)^2+1.2^2), sqrt((1.5-0.9)^2+1.2^2);
             sqrt(1.5^2+1.2^2),sqrt(1.5^2+1.2^2);
             sqrt((1.5-0.9)^2+1.2^2), sqrt((1.5+0.9)^2+1.2^2);
...
% y = 0,0037e-0,073x
data4 = [0.0037*exp(-0.073 * data(:,2)), 0.0008*exp(-0.094 * data(:,1))]
...
data(1,:) = [1.5,1.5];   % distancias iniciales
...
L = [1.2;0.9;1.2;1.2;0.9;0.9;1.2;1.2;1.2];                
